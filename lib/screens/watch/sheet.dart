    ...
    return Scaffold(
        ...
        body: CupertinoPageScaffold(
          child: Center(
              child: Hero(
                tag: 'image',
                child: Image.asset('assets/img/example/demo_image.jpeg'),
              )
          ),
        ),
      ...
      child: Column(
        ...
        children: <Widget>[
          CircularProgressIndicator(
            ...
            valueColor: new AlwaysStoppedAnimation<Color>(Color(0xff0d1117)),
          ),
          SizedBox(
            height: 30,
          ),
                  ...
                  Padding(
                      ...
                      child: ClipRRect(
                          ...
                          child: Hero(
                            tag: 'image',
                            child:
                            Image.asset('assets/img/example/demo_image.jpeg'),
                          )
                      )
                  ),
                  Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      ClipRRect(
                          ...
                          child: Image.asset(
                            'assets/img/example/demo_image.jpeg',
                            fit: BoxFit.cover,
                            height: 40,
                            width: 40,
                          )),
...
final people = [
  Item('MacBook Pro', 'assets/img/example/MacBook.jpg'),
  Item('Jaime Blasco', 'assets/img/example/jaimeblasco.jpeg'),
  Item('Mya Johnston', 'assets/img/example/person1.jpeg'),
  // https://images.unsplash.com/photo-1520813792240-56fc4a3765a7'
  Item('Maxime Nicholls',
      'assets/img/example/person4.jpeg'), //https://images.unsplash.com/photo-1568707043650-eb03f2536825'
  Item('Susanna Thorne',
      'assets/img/example/person2.jpeg'), //https://images.unsplash.com/photo-1520719627573-5e2c1a6610f0
  Item('Jarod Aguilar', 'assets/img/example/person3.jpeg')
  //https://images.unsplash.com/photo-1547106634-56dcd53ae883
];

final apps = [
  Item('Messages', 'assets/img/example/message.png'),
  Item('Github', 'assets/img/example/github_app.png'),
  Item('Slack', 'assets/img/example/slack.png'),
  Item('Twitter', 'assets/img/example/twitter.png'),
  Item('Mail', 'assets/img/example/mail.png'),
];
